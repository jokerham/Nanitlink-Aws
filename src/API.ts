...
export type PostsByModuleAndModuleIdAndPostIndexQueryVariables = {
  module: string,
  moduleIdPostIndex?: ModelPostByModuleCompositeKeyConditionInput | null,
...
export type PostsByModuleAndModuleIdAndPostIndexQuery = {
